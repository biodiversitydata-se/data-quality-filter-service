...
class QualityServiceSpec extends Specification implements ServiceUnitTest<QualityService>, DataTest {

    void setupSpec() {
        mockDomains(QualityProfile, QualityCategory, QualityFilter)
    }
