...
class OccurrenceTagLib {
    ...
    def download = { attrs, body ->
        ...
        log.debug("xhk205 search params = " + attrs.params.searchParams)
        log.debug("xhk205 qualityFiltersinfo = " + attrs.params.qualityFiltersInfo)
        attrs.params.qualityFiltersInfo.eachWithIndex{it,index ->
            log.debug("xhk205 filter[" + index + "]: " + it)
        }
        //log.debug("xhk2052 filters.size = " + attrs.params.qualityFiltersInfo.size())
